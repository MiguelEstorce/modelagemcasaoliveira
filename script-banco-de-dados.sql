CREATE DATABASE  IF NOT EXISTS `casa_oliveira_miguel` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `casa_oliveira_miguel`;
...
CREATE TABLE `cliente` (
  ...
  `estado_civil_cliente` enum('Solteiro(a)','Casado(a)','Divorciado(a)','Separação Juducial','Viuvo(a)','União Estável') NOT NULL,
...
CREATE TABLE `funcionario` (
  ...
  `enderoco_funcionario` varchar(255) NOT NULL,
  `email_funcionario` varchar(100) NOT NULL,
  `genero_funcionario` varchar(30) NOT NULL,
  `estado_civil_funcionario` enum('Solteiro(a)','Casado(a)','Divorciado(a)','Separação Juducial','Viuvo(a)','União Estável') NOT NULL,
...
CREATE TABLE `pagamento` (
  ...
  `forma_pagamento` enum('Pix','Credito','Debito','Dinheiro','Voucher') NOT NULL,
  `valor_pagar` decimal(7,2) NOT NULL,
  `numero_parcelas` int NOT NULL,
  `valor_parcelas` decimal(6,2) NOT NULL,
...
CREATE TABLE `cliente` (
  ...
  `genero_cliente` varchar(30) NOT NULL,
  `etnia_cliente` enum('Branca','Preto','Pardo','Indigena','Amarelo') NOT NULL,
  `telefone_cliente` varchar(15) DEFAULT NULL,
  `celular_cliente` varchar(15) NOT NULL,
  PRIMARY KEY (`id_cliente`),
  UNIQUE KEY `rg_cliente` (`rg_cliente`),
...
CREATE TABLE `funcionario` (
  `id_funcionario` int NOT NULL AUTO_INCREMENT,
  `nome_funcionario` varchar(15) NOT NULL,
  `rg_funcionario` varchar(15) NOT NULL,
  ...
  `etnia_funcionario` enum('Branca','Preto','Pardo','Indigena','Amarelo') NOT NULL,
  `dependentes` varchar(255) DEFAULT NULL,
  `salario` decimal(7,2) NOT NULL,
  `carga_horaria` int NOT NULL,
  `deficiencias` varchar(200) DEFAULT NULL,
...
CREATE TABLE `itens_venda` (
  ...
  `imposto` decimal(5,2) DEFAULT NULL,
